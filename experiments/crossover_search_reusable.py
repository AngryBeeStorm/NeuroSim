...
from neurosim.surrogate import flatten_candidate, train_surrogate
...
def run_ml_guided_evolution(
    ...
    for generation in range(generations):
        ...
        if generation < warmup_generations:
            ml_guidance_history.append(False)
            offspring = generate_offspring(elite_candidates, offspring_count, stimulation_length)
        else:
            ...
            candidate_pool = generate_offspring(elite_candidates, candidate_pool_size, stimulation_length)
            ...
            predicted_fitness = (surrogate.predict(candidate_pool_X))
    ...
    return {
        ...
        "final_elites": final_elite_candidates,
        "ml_guidance_history": ml_guidance_history,
    }
